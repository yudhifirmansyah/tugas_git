  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="{{ url('/') }}" target="_blank">
        ...
        <span class="ms-1 font-weight-bold">JB.INDO</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <!-- </li>
        <li class="nav-item">
          <a class="nav-link " href="{{ url('/report_produk') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          @guest
                            @if (Route::has('login'))
                                <li class="nav-item d-flex align-items-center">
                                  <a href="{{ route('login') }}" class="nav-link text-body font-weight-bold ">
                            ...
                            @if (Route::has('register'))
                                <li class="nav-item d-flex align-items-center">
                                  <a href="{{ route('register') }}" class="nav-link text-body font-weight-bold ">
                                    ...
                                    <span class="d-sm-inline d-none">{{ __('Register') }}</span>
                                  </a>
                                </li>
                            @endif
                        @else
